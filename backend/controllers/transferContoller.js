...
import { 
  ...
  export const getTransferRequests = async (req, res) => {
    try {
      ...
      // Populate related fields if desired.
  ...
  export const createTransferRequest = async (req, res) => {
    try {
      ...
      // Delegate creation to the transfer service.
   ...
   * - Main admin approves or rejects the transfer request.
   */
   ...
   * - Receiving school admin accepts or rejects an approved transfer request.
   */
