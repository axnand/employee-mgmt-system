...
//  * @param {mongoose.Types.ObjectId | String} [logData.office=null] - Office reference (ObjectId) if applicable.
//  * @param {String} logData.description - Brief description of the event.
//  * @param {String} [logData.ip] - IP address from which the event occurred.
//  */
// export const createLog = async ({
...
//     logger.info(
//       `Action: ${action} - Performed by: ${admin} (${role}) - Office: ${office || "-"} - Description: ${description} - IP: ${ip || "N/A"}`
//     );
